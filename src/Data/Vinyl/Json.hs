...
-- 'Maybe'.
_jf :: forall f s opt a b. (Functor f)
...
type family OptionalityOfIn (s :: TL.Symbol) (a :: *) (rs :: [(TL.Symbol, Optionality, *)]) :: Optionality where
